...
class TestDoubleit(object):
    ...
    numbers_file_template = 'C:\\Users\\John\\PycharmProjects\\corey_schafer_oops/testnums_template.txt'
    numbers_file_testor = 'C:\\Users\\John\\PycharmProjects\\corey_schafer_oops/testnums.txt'
    ...
    def test_doubleit_method1(self):
        ...
        assert doubleit.double(24) == 48, 'method double fails'
